...
| [PeoplePicker](PeoplePicker)                         | User Interface | [Fluent PeoplePicker control](https://developer.microsoft.com/en-us/fluentui#/controls/web/peoplepicker) for use in canvas & custom pages. | ✅         | ✅           | ✅            | ⬜                 | ⬜                 |
| [Persona](PeoplePicker)                         | User Interface | [Fluent Persona control](https://developer.microsoft.com/en-us/fluentui#/controls/web/persona) for use in canvas & custom pages. | ✅         | ✅           | ✅            | ⬜                 | ⬜                 |
...
| [SearchBox](SearchBox)                       | User Interface | [Fluent SearchBox control](https://developer.microsoft.com/en-us/fluentui#/controls/web/searchbox) for use in canvas & custom pages. | **✅**     | **✅**       | **✅**        | ⬜                 | ⬜                 |
