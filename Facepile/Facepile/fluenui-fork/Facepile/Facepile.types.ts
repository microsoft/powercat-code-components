...
import type { IRefObject, IRenderFunction, IStyleFunctionOrObject } from '@fluentui/react';
import type { IButtonProps } from '@fluentui/react';
import type { IPersonaSharedProps } from '@fluentui/react';
import type { IKeytipProps, Button, BaseButton } from '@fluentui/react';
...
export interface IFacepileProps extends React.ClassAttributes<FacepileBase> {
  ...
  /**
 * Issue 1 : Adding additional prop to achieve positive tab index
 * @defaultvalue 0
 */
  tabIndex?: number;
}
...
export interface IFacepilePersona extends React.ButtonHTMLAttributes<HTMLButtonElement | HTMLDivElement> {
   ...
   * called on click.
   */
  onClick?: (ev?: React.MouseEvent<any>, persona?: IFacepilePersona) => void | undefined;
