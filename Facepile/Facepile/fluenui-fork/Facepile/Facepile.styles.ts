...
import { hiddenContentStyle, HighContrastSelector, getFocusStyle, getGlobalClassNames } from '@fluentui/react';
import type { IFacepileStyleProps, IFacepileStyles } from '@fluentui/react';
