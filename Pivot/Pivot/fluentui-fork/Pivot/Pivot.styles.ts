...
import { AnimationVariables, FontWeights, getGlobalClassNames, getHighContrastNoAdjustStyle, HighContrastSelector, IPivotStyleProps, IPivotStyles, IsFocusVisibleClassName, IStyle, normalize } from '@fluentui/react';
