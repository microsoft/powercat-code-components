...
This code component provides a wrapper around the [Fluent UI Gauge chart](https://developer.microsoft.com/en-us/fluentui#/controls/web/gaugechart) control for use in canvas & custom pages.
