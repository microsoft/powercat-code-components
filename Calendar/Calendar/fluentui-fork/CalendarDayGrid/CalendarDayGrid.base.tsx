...
------------------------
This custom version of CalendarDayGrid.base.tsx is required to add custom focuszone with tabindex to the buttons of the Calendar
...
export const CalendarDayGridBase: React.FunctionComponent<ICalendarDayGridProps> = props => {
  ...
  return (
    <CustomFocusZone className={classNames.wrapper} tabIndex={tabIndex} shouldFocusInnerElementWhenReceivedFocus={true}>
      <table
