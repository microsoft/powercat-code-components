...
------------------------
This custom version of CalendarDay.Base is required to add the tabindex to the buttons of the Calendar
    ...
    <div className={classNames.root}>
      <div className={classNames.header}>
        <HeaderButtonComponentType
          ...
          tabIndex={onHeaderSelect ? tabIndex : -1} // prevent focus if there's no action for the button
  ...
  return (
    <div className={classNames.monthComponents}>
      <button
        ...
        tabIndex={prevMonthInBounds ? tabIndex : allFocusable ? tabIndex : -1}
      ...
      <button
        className={css(classNames.headerIconButton, {
         ...
         //Issue 1: Assigning tabIndex received instead of 0
        tabIndex={nextMonthInBounds ? tabIndex : allFocusable ? tabIndex : -1}
