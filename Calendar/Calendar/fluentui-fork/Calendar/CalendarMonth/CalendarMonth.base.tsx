...
------------------------
This custom version of CalendarMonth.Base is required to add custom focus zone with tabindex  to the buttons of the Calendar
  ...
  if (isYearPickerVisible) {
    ...
    return (
      <CalendarYear
        ...
        animationDirection={animationDirection}
        tabIndex={tabIndex}       //Issue 1: Assigning tabIndex received instead of default
      />
    );
  }
    ...
    <div className={classNames.root}>
      <div className={classNames.headerContainer}>
        <button
          ...
          tabIndex={!!props.onHeaderSelect || !yearPickerHidden ? tabIndex : -1}
          type="button"
        >
        ...
        <div className={classNames.navigationButtonsContainer}>
          <button
            ...
            //Issue 1: Assigning tabIndex received instead of 0
            tabIndex={isPrevYearInBounds ? tabIndex : allFocusable ? tabIndex : -1}
          ...
          <button
            ...
            //Issue 1: Assigning tabIndex received instead of 0
            tabIndex={isNextYearInBounds ? tabIndex : allFocusable ? tabIndex : -1}
      ...
      <CustomFocusZone tabIndex={tabIndex} shouldFocusInnerElementWhenReceivedFocus={true}>
