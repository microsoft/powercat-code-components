...
export interface ICalendarYearProps extends IBaseProps<ICalendarYear> {
    ...
    /**
     * Issue 1 : To achieve positive tab index
     * @defaultvalue 0
     */
    tabIndex?: number;
}

export type ICalendarYearStyleProps = ICalendarPickerStyleProps;

export type ICalendarYearStyles = ICalendarPickerStyles;
