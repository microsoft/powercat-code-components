...
------------------------
This custom version of CalendarMonth.Year is required to add custom focus zone with tabindex to the buttons of the Calendar
because at this time canvas apps adds a positive tabindex to all elements rather than relying on
dom ordering. 
*/
import * as React from 'react';
import { Icon } from '@fluentui/react';
import { KeyCodes, getRTL, classNamesFunction, css, format, IRefObject } from '@fluentui/utilities';
...
const CalendarYearHeader: React.FunctionComponent<ICalendarYearHeaderProps> = (props) => {
    const { styles, theme, className, animateBackwards, animationDirection, onRenderTitle, tabIndex } = props;
