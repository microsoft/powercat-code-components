...
import {FocusZone as FocusZoneCustom} from '../FocusZone/FocusZone';
...
export class CommandBarBase extends React.Component<ICommandBarProps, {}> implements ICommandBar {
  ...
  public render(): JSX.Element {
    ...
    return (
      <ResizeGroupAs
        ...
        tabIndex={undefined} // ISSUE 1: TabIndex - So that we don't add tabindex to the wrapped div
      />
    );
  }
  ...
  private _onRenderData = (data: ICommandBarData): JSX.Element => {
    ...
    return (
      <FocusZoneCustom
        ...
        // ISSUE: 1 - Need a postive tabindex and the custom FocusZone
      ...
      >
        ...
        <OverflowSet
          ...
          onRenderOverflowButton={this._onRenderOverflowButton as any}
        />
  ...
  private _onRenderItem = (item: ICommandBarItemProps): JSX.Element | React.ReactNode => {
    ...
    const commandButtonProps: ICommandBarItemProps = {
      ...
      onClick: this._onButtonClick(item) as any,
    };
